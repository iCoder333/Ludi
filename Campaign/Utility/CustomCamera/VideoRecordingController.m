...
- (void)setupTopToolBar {
    ...
    flashBtn.frame = CGRectMake(20, margin, btnWH, btnWH);
    [flashBtn setImage:[UIImage imageNamed:@"cameraDelete"] forState:UIControlStateNormal];
    [flashBtn setImage:[UIImage imageNamed:@"cameraDelete"] forState:UIControlStateSelected];
    ...
    switchCameraBtn.frame = CGRectMake(self.view.frame.size.width - btnWH - 20, margin, btnWH, btnWH);
...
- (void)setupBottomToolBar {
    ...
    recordingProgress.progressTintColor = [UIColor colorWithRed:41.0/255.0 green:144.0/255.0 blue:234.0/255.0 alpha:1.00];
...
- (void)saveVideoBtnBtnAction {
    ...
    if ([[defaults objectForKey:@"popup"] isEqualToString:@"submit"]) {
